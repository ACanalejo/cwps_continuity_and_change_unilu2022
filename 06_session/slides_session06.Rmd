...
Take-home points from Session 6:
  ...
  3. Since this dimension cannot account for major changes in Western European party systems, many scholars agree that a new dimension representing **a new culture cleavage is re-structuring political competition**
...
- That's way some scholars have proposed different measures that synthesize the different features that define party system stability
...
- In this session, we will review three major contributions:
  ...
  2. The contribution of Chiaramonte and its colleagues [@Chiaramonte2017; @Emanuele2019; @Emanuele2018]
...
1. Electoral volatility
    ...
    - Bartolini and Mair [-@Bartolini1990] analyse 3030 elections in the period 1885-1985 [-@Bartolini1990]

    - **Average level between 1945 and 1989**: 8.7 (meaning 91.3 of stability)
  
    - Some exceptions: Germany in 1920 (32.1) OR France in the 1950s (22.3 in average)
  
    - Curiously higher in the inter-war period (in which the frozen hypothesis is based on): 9.9
...
1. Electoral volatility
    ...
    - Mean **cross-cleavage volaitlity** in the post-war compared and interwar periods: 2.9 and 3.2 respectively
...
- Chiaramonte and his colleagues provide a series of studies updating the analyses of Mair. **Two approaches**:
...
- The results:
  ...
  1. **Party system innovation** has grown spcially since 2010
...
- How to measure **party system restraint**:
  ...
  2. **Party system fragmentation** (i.e., effective number of parties or weighted number of parties either with parliamentary presence or passing an electoral threshold)
...
- One controversial arguments in Mair [@Mair1993] is that **even if the social alignment of parties have changed, this doesn't mean that cleavage politics is dead**, but this doesn't take into account the possibility that ***cleavage poltics had changed***
