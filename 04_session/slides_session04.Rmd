...
Take-home points from Session 3:
  ...
  1. From a long-term perspective, **any important movement on one side of a dimension of conflict tends to trigger a counter-reaction** (conflicts are compounded of at least two confronted sides)
  
  2. Party system change needs of both **societal change** and **political opportunity**. In the case of PRR parties, the former has to do with the advance from industrial to post-industrial economies, and the latter with the weakening of party ties
...
Take-home points from Session 3:
  ...
  - However, in this session we will discuss whether this must be always the case or not. For that, we will be looking at **the effect of crises on party system change**

# Beyond NWE: the party systems of SE

## Beyond NWE: the party systems of SE

- So far, the examples have focused on NWE 
...
- Most of the cleavage theory were therefore founded on countries that belonged to the so-called **first and second waves of democratization** (before and after the inter-war period, respectively)
...
- However, the autocracies of Greece, Portugal and Spain (as well as that of Italy before the 2nd World War) were **far-right autocracies** instead of communist regimes
...
- Party systems in SE resemble those of NWE (but not those of CEE) because they all institutionalised very quickly after the first democratic election
...
- **Why did party systems of SE institutionalised more and quicker than party systems in CEE?**
...
- **Of what crises across the world can you think of? What political change have/could brought?**
...
- **Italy**, as mentioned before, is the only Southern European country that followed the **patterns of NWE**

- It became a **full democracy after the 2nd World War** with a bipolar party system characterised by two strong main parties at each pole of the left-right dimension: the Christian democrats (PDC) and the Communist party (PCI)

- It also witness the **consequences of May 1968**. This generated an echo of strong protests in 1969 all over the country, but specially in the north. These protests where followed by the emergence of **environmentalist parties** that, however, had only **limited success**
...
- However, the main factor driving party system change was the **tangentopoli or 'mani pulite'** (*clean hands*) scandals. This is the name given to an investigation that took place between 1992 and 1994 by a group o Milanese prosecutors on Italian political parties
...
- As a result of it, **many parties splinted**, most importantly, the Christian democratic party, and **many new parties emerged**

- Most importantly, the media magnate **Silvio Berlusconi** used their resources to exploit the discontent and create the party **Forza Italia**, that quickly became the first party at the polls
...
- In sum, **the whole party system changeD from the 1990 to the 1994 election, registering the highest levels of volatility and party system fragmentation in the modern history of Western Europe**
...
- **So what did happen here?**
  ...
  8. In addition, **change of the electoral law** to a majoritarian FPTP system in a highly geographically fragmented country (interplay of institutional and societal factors)
...
- Unequal across Europe
  ...
  1. In NWE and CEE benefited opposition countries in most countries
  
  2. In SE provoked the massive entry of challenger parties
  
## The impact of crises on party systems: the Great Recession

- A **challenger party** is operationalised as a party that has not yet participated in the alternation of government [@Hobolt2016]
...
- Why did Portugal's party system remain mostly unchanged? 
  ...
  1. It came from a period of economic decline already (i.e., weaker shock)
  
  2. The left party in opposition accommodated the demands of the citizenry
...
- This means that volatility has remained high in tose countries that experienced the strongest party system shocks after the Great Recession
