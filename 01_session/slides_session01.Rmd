...
2. The **socio-historical approach**
    ...
    + The structure of party-systems in Europe is highly dtermined by the lines of conflict politicized in each country
    ...
    + These common shocks affect each country differently nonetheless (most importantly to Lipset and Rokkan: the industrial  and national revolutions)
    ...
    + **Any example of what may be and what may not be a cleavage in any European country?**
...
- **What are the mechanisms underlying these processes?** (i.e., the story behind)
