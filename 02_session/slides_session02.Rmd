...
```{r, figures-side, fig.show="hold", out.height = "50%", out.width="50%", fig.cap = "Image from the French revolts of May 1968 (Cpyright: Bruno Barbey/Magnum Photos)"}
...
Therefore, we must consider at least four factors to explain the unqual success of green parties:
...
- Elderly parties, animal rights parties, latino parties, etc.
...
- However, it may be the case that a newly politicised issue performed independently for a while
...
- With the increasing saliency of global warming and the imminent challenges of climate change, some scholars and pundits have argued that a new wave of green parties is coming
...
- However, they are far from dominate dynamics of political competition
